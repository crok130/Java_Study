 ...
 * 객체 지향프로그래밍은 프로그램 구현에 필요한 객체를 파악하고
 * 상태와 행위를 가진 객체를 만들고
 ...
 * 절차 지향 - 일어나는 일을 시간순으로 프로그래밍 하는 것
 * 
 * 아침에 일어난다.
 * 씻는다.
 * 밥을 먹는다.
...
public class StudentExample {
	...
	public static void main(String[] args) {
		...
		Teacher t1 = null;	// 참조 타입은 null로 초기화 가능
		if(t1 == null) {
			t1 = new Teacher();
		}
