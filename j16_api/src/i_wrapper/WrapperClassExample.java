 ...
 * 연산에 필요한 상수와 기능을 추가앟여 묶어놓은 class
...
public class WrapperClassExample {
	...
	public static void main(String[] args) {
		...
		// 문자열 또는 기본 타입의 테이터를
		// 해당 타입의 포장객체로 변호한
		// 주로 문자열에 저장된 데이터가 기본타입으로
		// 반환할 수 있는 데이터를 저장하고 있다면
		// 기본타입으로 반환 할때 사용
		...
		System.out.println("=============================================");
		// Wrapper class 가 가진 기능등
		// 어느 범위까지 데이터 사용이 가능하지 상수로 표현
